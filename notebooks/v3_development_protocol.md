...
Status: prospective specification; commit this file before inspecting the full
corrected development rerun. The later decision artifact records this file's
SHA-256 and the verified run's source and input fingerprints. This is a
repository specification, not an external registration.
