...
\input{sections/01_executive}
\input{sections/02_evolution}
\input{sections/03_data_and_architecture}
\input{sections/04_execution_model}
\input{sections/05_research_design}
\input{sections/06_results}
\input{sections/07_failures_and_limits}
\input{sections/08_status_and_reproduction}
