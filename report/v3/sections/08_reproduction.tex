...
The protocol hash identifies its bytes at the recorded V3 research commit.
The current Markdown copy has punctuation edits after completion. Verification
reads the committed original, and the report asset manifest records both
identities.
