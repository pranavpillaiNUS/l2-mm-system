...
> commit `1066950` under execution model
...
at commit `1066950`. They remain valid records of the experiment that was run,
...
- At frozen commit `1066950`, `scripts/run_l2_panel.py` remeasured Phase A at
...
The frozen V2 replay path belongs to commit `1066950`. Run the following only
