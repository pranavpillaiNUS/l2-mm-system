...
from scripts.summarize_v3_development import build_summary, protocol_bytes
...
PROTOCOL_SHA256 = "e1890d2e4fa715154f28778febe3367d391a8c8be1b44b766b4ccc0decf3e395"
PINNED_INPUTS = {
...
def validate_summary() -> tuple[dict, dict]:
    ...
    recorded_protocol = protocol_bytes(PROTOCOL, manifest["source_verification"]["revision"])
    if (published["protocol"]["sha256"] != PROTOCOL_SHA256
            or hashlib.sha256(recorded_protocol).hexdigest() != PROTOCOL_SHA256):
...
def write_manifest(outputs: list[Path], research_manifest: dict, extra_inputs: list[Path]) -> Path:
    ...
    payload = {
        ...
        "research_verification": {
            ...
            "protocol": {
                "path": str(PROTOCOL), "sha256": PROTOCOL_SHA256,
                "revision": research_manifest["source_verification"]["revision"],
            },
        },
